...
def welcome():
    exit_game = False
    while not exit_game:
        gamewindow.fill((233,222,232))
        text_screen("Welcome To HUNGRY SNAKE", black, 170, 250)
        text_screen("PRESS SPACE TO PLAY", black, 230, 400)
...
def gameloop():
    ...
    while  not exit_game:
        if game_over:
            ...
            text_screen(" Press ENTER TO Continue", red, 180, 530)
